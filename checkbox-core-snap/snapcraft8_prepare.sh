...
rsync -r --links common_files/ ..
echo "Copying over series file"
rsync -r --links $series/snap ..
...
echo "You can commit your changes for snapcraft remote-build with this:"
echo "  git add ../common_files && git add ../$series && && git add ../version.txt && git commit -m \"Prepared build\""
