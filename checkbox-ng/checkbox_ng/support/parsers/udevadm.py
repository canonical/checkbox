...
from checkbox_ng.support.lib.bit import test_bit
from checkbox_ng.support.lib.input import Input
from checkbox_ng.support.lib.pci import Pci
from checkbox_ng.support.lib.usb import Usb
...
class UdevadmDevice(object):
    ...
    def name(self):
        if self._name is not None:
            return self._name
        # For nvme DISK devices without a DEVNAME, derive the name from
        # DEVPATH
        if (
            self.bus == "nvme"
