...
from checkbox_ng.support.snap_utils.snapd import AsyncException, Snapd


class TestSnapd(TestCase):
    @patch("checkbox_ng.support.snap_utils.snapd.time.sleep")
    @patch("checkbox_ng.support.snap_utils.snapd.time.time")
