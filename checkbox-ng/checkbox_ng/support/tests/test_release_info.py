...
from checkbox_ng.support.release_info import (
    get_release_info,
...
class OsResourceTests(unittest.TestCase):
    ...
    def test_get_release_file_content(self):
        with patch(
            "checkbox_ng.support.release_info.open",
    ...
    def test_get_release_file_content_classic(self):
        ...
        with patch("checkbox_ng.support.release_info.open", open_mock):
            os_release_data = get_release_file_content()
        self.assertIn("UBUNTU_CODENAME=noble\n", os_release_data)

    @patch("checkbox_ng.support.release_info.get_release_file_content")
