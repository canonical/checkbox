...
class SessionStateExporterBaseTests(TestCase):
    ...
    def test_option_list_init_non_boolean(self):
        ...
        exporter = self.TestSessionStateExporter([f"{option}=detailed"])
    ...
    def test_defaults(self):
        ...
        session_manager = mock.Mock(
            spec_set=SessionManager, state=self.make_test_session()
        )
    ...
    def test_all_at_once(self):
            ...
            "result_map": {
                "job_a": OrderedDict(
                    [
                        ...
                        (
                            "hash",
                            "2def0c995e1b6d934c5a91286ba164"
                ...
                "job_b": OrderedDict(
                    [
                        ...
                        (
                            "hash",
                            "ed19ba54624864a7c622ff7d1e8ed5"
        ...
        for key in data.keys():
            self.assertEqual(
                expected_data[key], data[key], msg="wrong data in %r" % key
            )
    ...
    def test_io_log_processors(self):
        ...
        self.assertEqual(
            cls._squash_io_log(io_log), ["Zm9vCg==", "YmFyCg==", "cXV4eAo="]
        )
        self.assertEqual(cls._flatten_io_log(io_log), "Zm9vCmJhcgpxdXh4Cg==")
        self.assertEqual(
            cls._io_log(io_log),
            [
                (0, "stdout", "Zm9vCg=="),
    ...
    def test_category_map(self):
        ...
        job_froz = JobDefinition(
            {"plugin": "shell", "id": "froz", "category_id": "foo"}
        )
