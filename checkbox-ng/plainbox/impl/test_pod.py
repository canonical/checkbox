...
class FieldTests(TestCase):
    ...
    def test_obj_reads(self):
        ...
        self.field.gain_name("field")
        self.assertEqual(
            self.field.__get__(self.instance, self.owner), self.instance._field
        )
...
class PODTests(TestCase):
    ...
    def test_initializer_duplicate_field_value(self):
        ...
        with self.assertRaisesRegex(TypeError, "field initialized twice: f"):
            T(1, f=2)
    ...
    def test_smoke(self):
        ...
        self.assertEqual(Person.field_list, [Person.name, Person.age])
        joe = Employee("Joe")
        # Methods still work
