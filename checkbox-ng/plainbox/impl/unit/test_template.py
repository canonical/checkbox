...
class TemplateUnitTests(TestCase):
    ...
    def test_resource_namespace__bare(self):
        ...
        """
        self.assertEqual(
            TemplateUnit({"template-resource": "resource"}).resource_namespace,
            None,
        )
    ...
    def test_resource_namespace__implicit(self):
        ...
        self.assertEqual(
            TemplateUnit(
                {"template-resource": "resource"}, provider=provider
            ).resource_namespace,
            provider.namespace,
        )
    ...
    def test_resource_id__bare(self):
        ...
        """
        self.assertEqual(
            TemplateUnit({"template-resource": "resource"}).resource_id,
            "resource",
        )
    ...
    def test_template_resource__bare(self):
        self.assertEqual(
            TemplateUnit({"template-resource": "resource"}).template_resource,
            "resource",
        )
...
class TemplateUnitFieldValidationTests(UnitFieldValidationTests):
    ...
    def test_template_id__bare(self):
        ...
        message = (
            "template 'ns::id', field 'template-id', identifier cannot "
    ...
    def test_template_summary__short_line(self):
        issue_list = self.unit_cls(
            {"template-summary": "x" * 81}, provider=self.provider
        ).check()
        self.assertIssueFound(
            issue_list,
            self.unit_cls.Meta.fields.template_summary,
