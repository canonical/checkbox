...
class TestMountUsbStorage(unittest.TestCase):
    ...
    @patch("checkbox_support.scripts.usb_read_write.os.path.join", return_value="/dev/sda1")
    ...
    def test_mount_usb_storage_success(self, mock_exit, mock_join, mock_call):
        ...
        with patch("checkbox_support.scripts.usb_read_write.FOLDER_TO_MOUNT", "/mnt/usb"):
    ...
    @patch("checkbox_support.scripts.usb_read_write.subprocess.call")
    @patch("checkbox_support.scripts.usb_read_write.os.path.join", return_value="/dev/sda1")
    @patch("checkbox_support.scripts.usb_read_write.sys.exit", side_effect=SystemExit)
