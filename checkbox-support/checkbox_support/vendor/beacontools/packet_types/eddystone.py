...
class EddystoneUIDFrame:
    ...
    def __str__(self):
        return (
            "EddystoneUIDFrame<tx_power: %d, namespace: %s, instance: %s>"
...
class EddystoneEncryptedTLMFrame:
    ...
    def __str__(self):
        return (
            "EddystoneEncryptedTLMFrame<encrypted_data: %s, salt: %d, mic: %d>"
...
class EddystoneTLMFrame:
    ...
    def __str__(self):
        return (
            "EddystoneTLMFrame<voltage: %d mV, temperature: %d Celsius, advertising count: %d,"
            " seconds since boot: %d>"
            % (
                self.voltage,
                self.temperature,
                self.advertising_count,
                self.seconds_since_boot,
            )
        )


class EddystoneEIDFrame:
    """Eddystone EID frame."""
