...
ManufacturerSpecificData = Struct(
    ...
    "data"
    / Switch(
        lambda ctx: ctx.company_identifier,
        {
...
HciEventHeader = Struct("evt" / Byte, "plen" / Byte)
...
HciAdReportEvent = Struct(
    ...
    Check(
        this.subevent
        in [EVT_LE_ADVERTISING_REPORT, EVT_LE_EXT_ADVERTISING_REPORT]
    ),
    "num_reports" / Byte,
    "reports"
    / Array(
