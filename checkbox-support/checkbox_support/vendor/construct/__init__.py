...
from checkbox_support.vendor.construct.core import *
from checkbox_support.vendor.construct.expr import *
from checkbox_support.vendor.construct.debug import *
from checkbox_support.vendor.construct.version import *
from checkbox_support.vendor.construct import lib
...
__all__ += [f"Float{n}{bln}" for n in (16, 32, 64) for bln in "bln"]
