...
class TestCheckGpio(unittest.TestCase):
    ...
    def test_parse_mixed(self):
        ...
        self.assertEqual(
            check_gpio.parse_config("1,3:5,7,9:10"), [1, 3, 4, 5, 7, 9, 10]
        )
    ...
    def test_connect_interface_success(self, mock_snapd, mock_print):
        ...
        snap = "checkbox_snap"
        timeout = 30
        check_gpio.connect_interface(gadget_name, gpio_slot, snap, timeout)
    ...
    def test_interface_test(self, mock_disconnect, mock_connect):
        gadget_name = "gadget"
        gpio_slot = "gpio-499"
        ...
        with check_gpio.interface_test(gpio_slot, gadget_name):
            mock_connect.assert_called_once_with(
                gadget_name, gpio_slot, "checkbox_snap", 30
            )
