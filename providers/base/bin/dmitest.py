...
def standard_tests(args, stream, dmi_data):
    ...
    if args.test_type == "server":
        ...
        if find_in_section(
            ...
            "Type:",
            ["portable", "notebook", "space-saving", "all in one"],
            False,
        ):
            dmi_data["Base Board Information"][
                "Type"
        ...
        if find_in_section(
            ...
            "Base Board Information",
            "Type:",
            ["rack mount", "server", "multi-system", "interconnect board"],
            False,
        ):
            dmi_data["Base Board Information"][
                "Type"
    ...
    if find_in_section(
        ...
        "Base Board Information",
        "Product Name:",
        ["base board product name", r"to be filled by o\.e\.m\."],
        False,
    ):
        dmi_data["Base Board Information"][
            "Product Name"
...
def version_tests(args, stream, dmi_data):
    ...
    if find_in_section(
        ...
        "Base Board Information",
        "Version:",
        ["base board version", r"x\.x", "empty", r"to be filled by o\.e\.m\."],
        False,
    ):
        dmi_data["Base Board Information"][
            "Version"
...
def serial_tests(args, stream, dmi_data):
    ...
    if find_in_section(
        ...
        "System Information",
        "Serial Number:",
        [r"to be filled by o\.e\.m\.", "system serial number", r"\.\.\.\.\."],
        False,
    ):
        dmi_data["System Information"][
            "Serial Number"
...
def main():
    ...
    parser.add_argument("--dmifile", help="File to use in lieu of dmidecode.")
    parser.add_argument(
        "--show_dmi",
        action="store_true",
    ...
    if find_in_section(
        ...
        "Processor Information",
        "Version:",
        ["sample", r"Genuine Intel\(R\) CPU 0000"],
        False,
    ):
        dmi_data["Processor Information"][
            "Version"
