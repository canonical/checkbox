...
import os
import subprocess
from ishtp import get_release_version, is_module_loaded, check_modules, check_devices
...
class TestISHTP(unittest.TestCase):
    ...
    @patch("subprocess.check_output", side_effect=subprocess.CalledProcessError(1, "lsmod"))
