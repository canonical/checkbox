...
class TestWatchdogConfigTest(unittest.TestCase):
    ...
    def test_configure_watchdog_config(
        ...
        # Mock the parser instance that read() would operate on
    ...
    def test_trigger_system_reset(
        ...
        calls = [call(shlex.split("sync")), call(shlex.split("sleep 5"))]
        mock_run.assert_has_calls(calls)
    ...
    def test_watchdog_reset_test_when_watchdog_available(
        ...
        mock_subprocess_run.assert_has_calls(
            [
                unittest.mock.call(shlex.split("sync")),
                unittest.mock.call(shlex.split("systemctl reboot")),
            ]
        )
