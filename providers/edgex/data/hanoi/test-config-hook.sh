...
conf_to_env[service_boot-timeout]="SERVICE_BOOTTIMEOUT/60000"
conf_to_env[service_check-interval]="SERVICE_CHECKINTERVAL/'20s'"
...
conf_to_env[service_protocol]="SERVICE_PROTOCOL/'http'"
conf_to_env[service_max-result-count]="SERVICE_MAXRESULTCOUNT/25000"
conf_to_env[service_read-max-limit]="SERVICE_READMAXLIMIT/200"
conf_to_env[service_startup-msg]="SERVICE_STARTUPMSG/'hello,world!'"
conf_to_env[service_timeout]="SERVICE_TIMEOUT/10000"

# [Clients.Command]
conf_to_env[clients_command_port]="CLIENTS_COMMAND_PORT/12"

# [Clients.Coredata]
conf_to_env[clients_coredata_port]="CLIENTS_COREDATA_PORT/12"

# [Clients.Data]
#
# NOTE - this key is present because device-sdk-go used a different
# key for CoreData than the core services, which use the previous key.
#
conf_to_env[clients_data_port]="CLIENTS_DATA_PORT/12"

# [Clients.Metadata]
conf_to_env[clients_metadata_port]="CLIENTS_METADATA_PORT/13"

# [Clients.Notifications]
conf_to_env[clients_notifications_port]="CLIENTS_NOTIFICATIONS_PORT/14"

# [Clients.Scheduler] - sys-mgmt-only
conf_to_env[clients_scheduler_port]="CLIENTS_SCHEDULER_PORT/14"

# [MessageQueue] -- core-data ONLY!
conf_to_env[messagequeue_topic]="MESSAGEQUEUE_TOPIC/'fubar'"

# [SecretStore] -- !app-service-configurable
conf_to_env[secretstore_additional-retry-attempts]="SECRETSTORE_ADDITIONALRETRYATTEMPTS/20"
conf_to_env[secretstore_retry-wait-period]="SECRETSTORE_RETRYWAITPERIOD/'10s'"
...
validate_service_env()
{
    ...
    testFile=$(cat "./test-files/$service.env" | sort)
