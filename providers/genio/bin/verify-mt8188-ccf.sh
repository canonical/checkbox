...
sed -i 's/_self$/sf/g' clk-table-parsed.txt
sed -i 's/^apmixed_//g' clk-table-parsed.txt
sed -i 's/^top_//g' clk-table-parsed.txt
sed -i 's/_top_/_/g' clk-table-parsed.txt
sed -i 's/_top$//g' clk-table-parsed.txt
sed -i 's/_ck_/_/g' clk-table-parsed.txt
sed -i 's/_ck$//g' clk-table-parsed.txt
sed -i 's/_clk$//g' clk-table-parsed.txt
sed -i 's/en_v/v/g' clk-table-parsed.txt
sed -i 's/_bclk$/b/g' clk-table-parsed.txt
sed -i 's/bclk$/b/g' clk-table-parsed.txt
sed -i 's/_hclk$/h/g' clk-table-parsed.txt
sed -i 's/_h$/h/g' clk-table-parsed.txt
sed -i 's/pclk/p/g' clk-table-parsed.txt
sed -i 's/_src$//g' clk-table-parsed.txt
sed -i 's/device_/d/g' clk-table-parsed.txt
sed -i 's/rg_//g' clk-table-parsed.txt
...
sed -i 's/_top_/_/g' clk-summary-parsed.txt
sed -i 's/_top$//g' clk-summary-parsed.txt
sed -i 's/^hd_//g' clk-summary-parsed.txt
sed -i 's/_set$//g' clk-summary-parsed.txt
sed -i 's/_ck_/_/g' clk-summary-parsed.txt
sed -i 's/_ck$//g' clk-summary-parsed.txt
sed -i 's/_clk$//g' clk-summary-parsed.txt
sed -i 's/_bclk$/b/g' clk-summary-parsed.txt
sed -i 's/bclk$/b/g' clk-summary-parsed.txt
sed -i 's/_hclk$/h/g' clk-summary-parsed.txt
sed -i 's/_h$/h/g' clk-summary-parsed.txt
