...
def get_network_interfaces(category):
    ...
    output = sp.check_output(cmd, shell=True).decode(sys.stdout.encoding, errors='ignore')
...
class NmInterfaceState():
    ...
    def parse(self, data=None):
        if data is None:
            ...
            data = sp.check_output(cmd, shell=True).decode(sys.stdout.encoding, errors='ignore')
