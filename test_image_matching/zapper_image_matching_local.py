...
def compare_two_images(reference, template, name):
    ...
    print(f"Found {name} at position: ({center[0]}, {center[1]})")
    return center
...
if __name__ == "__main__":
    ...
    number_2_pos = compare_two_images(calc_top, number_2, "number 2 button")
    print("Clicking the number 2 button")
    click_position(zapper_ip, number_2_pos)
    time.sleep(2)

    plus_pos = compare_two_images(calc_top, plus, "plus button")
    print("Clicking the plus button")
    ...
    equal_pos = compare_two_images(calc_top, equal, "equal button")
    print("Clicking the equal button")
    click_position(zapper_ip, equal_pos)
    time.sleep(2)

    result = cv2.imread("images/result.jpg")
    result_pos = compare_two_images(calc_top, result, "result")
    time.sleep(3)
