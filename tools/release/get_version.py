...
def bump_version(
    ...
    major, minor, patch = {
        TraceabilityEnum.BREAKING: (major + 1, 0, 0),
        TraceabilityEnum.NEW: (major, minor + 1, 0),
        TraceabilityEnum.BUGFIX: (major, minor, patch + 1),
        TraceabilityEnum.INFRA: (major, minor, patch),
    }[needed_bump]
